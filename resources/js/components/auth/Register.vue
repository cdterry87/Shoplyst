            ...
            <v-container fluid fill-height>
                <v-layout align-center justify-center wrap>
                    <v-flex xs12 sm10 md5 class="box">
                        ...
                        <v-text-field color="white" label="Confirm Password" filled prepend-inner-icon="mdi-lock" id="password_confirmation" name="password_confirmation" type="password" :rules="[v => !!v || 'Password Confirmatino is required']" required></v-text-field>
